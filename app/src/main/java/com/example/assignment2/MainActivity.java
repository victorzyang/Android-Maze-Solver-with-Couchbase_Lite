    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        solveMazeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Step 2: create document (i.e. a record) in the database. (I have this done in the ButtonCell class actually)
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    for (Result result : rs) {
                        ...
                        mazesDictToString += result.getDictionary("maze").getBoolean("solutionExists"); //TODO: fix this (this is incorrect)
                        mazesDictToString += "}";
